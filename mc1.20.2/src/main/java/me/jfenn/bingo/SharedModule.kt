...
val sharedModule = module {
    ...
    singleOf(::ItemStackFactory) bind IItemStackFactory::class
    singleOf(::JsonSerializers) bind IJsonSerializers::class
    ...
    singleOf(::ServerWorldFactory) bind IServerWorldFactory::class
